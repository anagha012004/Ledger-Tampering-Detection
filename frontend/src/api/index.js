...
export const bcStats         = ()           => api.get('/blockchain/stats')
export const bcTamperHistory = ()           => api.get('/blockchain/tamper-history')
export const bcEvents        = ()           => api.get('/blockchain/events')
